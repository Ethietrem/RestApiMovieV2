...
/**
 * MovieLibrary generated by hbm2java
 */
...
public class MovieLibrary  implements java.io.Serializable {
    ...
    public MovieLibrary(Movie movie, MovieLibraryStatus movieLibraryStatus, UserAccount userAccount, Date created, Date modified) {
       this.movie = movie;
