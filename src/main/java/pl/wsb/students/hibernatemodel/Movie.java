...
public class Movie  implements java.io.Serializable {
    ...
    public Movie(Director director, MovieGenre movieGenre, Date created, Date modified, String title, String releaseYear, String comment, Integer deleted,
                 Set<MovieLibrary> movieLibraries, Set<MovieActor> movieActors, Set<MovieRating> movieRatings) {
