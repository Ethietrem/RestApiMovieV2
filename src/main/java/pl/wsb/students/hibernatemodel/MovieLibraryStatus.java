...
/**
 * MovieLibraryStatus generated by hbm2java
 */
@Entity
@Table(name = "movie_library_status", catalog = "java_wsb", uniqueConstraints =
...
public class MovieLibraryStatus  implements java.io.Serializable {
    ...
    public MovieLibraryStatus(Date created, Date modified, String name, String abbr, Integer deleted, Set<MovieLibrary> movieLibraries) {
